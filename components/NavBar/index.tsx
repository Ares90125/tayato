...
const NavBar: React.FC = () => (
  <div className='shadow-sm navbar min-h-12 fixed top-0 z-50 p-0 md:flex'>
    <div className='md:mx-2 flex-1 px-2'>
      <div className='relative'>
        <button className='btn bg-transparent btn-sm border-none text-primary' aria-label='Menu' type='button' aria-haspopup='true' aria-expanded='false'>
          <svg className='fill-current stroke-0 w-[12px] h-[12px]' viewBox='0 0 512 512'>
      ...
      <div className='flex items-center basis-full space-x-7 px-2'>
          <a href="/">
            <svg className="block mx-auto max-h-6 transition-all duration-300" width="165.53" height="46.384" viewBox="0 0 165.53 46.384"><g transform="translate(-11.648 -13.2)">
          ...
          <div className='flex-grow'>
            <div className='relative w-full md:max-w-3xl mx-auto '>
              <form>
              <input className="text-base cursor-text w-full input-md flex text-gray-700 rounded-full pr-20 outline-offset-0 outline-1 placeholder:text-gray-500/80 transition-all duration-300 focus:transition-all hover:outline-gray-400 focus:outline-offset-0 font-bold font-arabic undefined placeholder:text-gray-600 max-w-[240px] focus:max-w-full bg-transparent focus:bg-gray-300/60 pl-10 !outline-none :text-gray-500 w-full focus:placeholder:text-gray-500 rounded-lg h-10 bg-clip-padding text-gray-700 pr-3 w-full" placeholder="Rechercher sur tayara" value=""/>
              </form>
            </div>
          </div>
      </div>
    ...
    <div className='gap-4 ml-2'>
      <button aria-label="Ancienne version" className="btn normal-case font-bold border-none undefined btn-ghost text-gray-700 text-xs font-medium hover:bg-transparent hover:text-gray-900 font-arabic">
        <span className="flex h-full w-full items-center gap-x-1 gap-y-[2.5px] flex-row">
          ...
          <span className="sm:ml-0.5 justify-center flex w-full">Ancienne version</span>
        </span>
      </button>
    </div>
  </div>
