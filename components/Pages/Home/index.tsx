  ...
  return (
    <div className='pt-16'>
      <div className='mt-10 md:mt-12 mx-auto pt-1 h-20 md:h-20'>
        <svg className="h-full block mx-auto max-h-28 transition-all duration-300 w-[210px] h-[75px]" viewBox="0 0 185.53 45.384"><g transform="translate(-11.648 -13.2)">
      ...
      <div className='flex flex-wrap '>
        {data.map((resource, index) => {
          return (
            <div key={index} className='transition xl:w-1/4 2xl:w-1/6 md:w-1/3 vertical-masonry-margin p-4 sm:w-1/2  mb-auto hover:scale-105'>
              <Card />
            </div>
          );
        }
